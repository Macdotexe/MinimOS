...
toolchain_binutils: $(TOOLCHAIN_PREFIX)/bin/1686-elf-ld

$(TOOLCHAIN_PREFIX)/bin/1686-elf-ld: $(BINUTILS_SRC).tar.xz
...
toolchain_gcc: $(TOOLCHAIN_PREFIX)/bin/1686-elf-gcc

$(TOOLCHAIN_PREFIX)/bin/1686-elf-gcc: toolchain_binutils $(GCC_SRC).tar.xz
