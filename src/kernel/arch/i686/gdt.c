...
typedef struct
{
    ...
    uint8_t BaseMid;            // base (bits 16-23)
...
typedef enum
{
    ...
    GDT_ADDRESS_CODE_CONFORMING             = 0x04,
    GDT_ACCESS_DATA_DIRECTION_NORMAL        = 0x00,
    GDT_ACCESS_DATA_DIRECTION_DOWN          = 0x00,

    GDT_ACCESS_DATA_SEGMENT                 = 0x00,
    GDT_ACCESS_CODE_SEGMENT                 = 0x00,
    
    GDT_ACCESS_DESCRIPTOR                   = 0x00,

    GDT_ACCESS_RING0                        = 0x00,
    GDT_ACCESS_RING1                        = 0x00,
    GDT_ACCESS_RING2                        = 0x00,
    GDT_ACCESS_RING3                        = 0x00,
...
void __attribute__((cdecl)) i686_GDT_Load(
